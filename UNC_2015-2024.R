...
setwd("C:/Users/Alvaro/Documents/DataUniversidades/presupuesto_UNC-main/")
...
p <- ggplot(data_mensual, aes(x=fecha)) +
  ...
  geom_point(aes(y=credito_devengado_real, color="credito_devengado_real")) + # Add this line
  scale_x_date(date_breaks = "1 year", date_labels = "%Y-%b", limits=as.Date(c("2017-03-01","2024-02-01"))) +
  labs(title = "Crédito devengado por mes",
       x = "Fecha",
       y = "Credito devengado") +
